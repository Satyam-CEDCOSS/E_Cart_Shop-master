        ...
        <div class="row gy-3">
          ...
          <div class="order-lg-last col-lg-10 col-sm-8 col-8">
            <div class="d-flex float-end">
              ...
              <a href="/login.php" class="me-1 border rounded py-1 px-3 nav-link d-flex align-items-center">
                <i class="fas fa-shopping-cart m-1 me-md-2"></i>
                <p class="d-none d-md-block mb-0">My orders</p>
              </a>
              <a href="/login.php" class="me-1 border rounded py-1 px-3 nav-link d-flex align-items-center" id="sign_in">
