                            ...
                            <div class='card-body p-4'>
                                <div class='row d-flex justify-content-between align-items-center'>
                                    ...
                                    <div class='col-md-3 col-lg-3 col-xl-2 d-flex'>
                                        <button class='btn btn-link px-2' onclick='dec_cart(".$key.")'>
                                            <i class='fas fa-minus'></i>
                                        </button>
    
                                        <span class='m-2'>".$_SESSION["cart"][$key]."</span>
    
                                        <button class='btn btn-link px-2' onclick='inc_cart(".$key.")'>
                                            <i class='fas fa-plus'></i>
                                        </button>
                                    </div>
                                    <div class='col-md-3 col-lg-2 col-xl-2 offset-lg-1'>
                                        <h5 class='mb-0'>$".$_SESSION["display"][$key]["price"]*$_SESSION["cart"][$key]."</h5>
                                    </div>
                                    <div class='col-md-1 col-lg-1 col-xl-1 text-end'>
                                        <a href='#!' class='text-danger' onclick='del_cart(".$key.")'><i class='fas fa-trash fa-lg'></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>";
